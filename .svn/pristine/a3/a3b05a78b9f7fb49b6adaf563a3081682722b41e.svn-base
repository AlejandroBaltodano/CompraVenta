    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "La clave se ha establecido."
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            var usuario = context.Users.SingleOrDefault(u => u.Id == idUser);
            ...
            if (result.Succeeded)
            {
                ...
                string cuerpo = "Le informamos que el cambio de clave de la cuenta del usuario [ " + User.Identity.GetUserName() + " ] se ejecutó satisfactoriamente.";
                coordinadorDeUsuarios.EnviarCorreoElectronico(usuario.Email, asunto, cuerpo);
